...
public class MainActivity extends AppCompatActivity
    ...
    private List<MovieEntity> savedMovies;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allMovies.getAll().observe(this, new Observer<List<MovieEntity>>() {
            ...
            public void onChanged(List<MovieEntity> movieEntities) {
                savedMovies = movieEntities;
                adapter.setMovies(movieEntities);
            }
        });
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(this, recyclerView ,new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onLongItemClick(View view, int position) {
                        allMovies.delete(savedMovies.get(position));
                    }
                })
        );
        //generated code
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
       ...
       //    String priority = data.getStringExtra(AddListActivity.EXTRA_PRIORITY);
